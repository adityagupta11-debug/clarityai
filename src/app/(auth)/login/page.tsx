      ...
      <div className="hidden lg:flex flex-col justify-center w-1/2 p-12 relative overflow-hidden border-r border-white/5 bg-[#050505]">
        ...
        <div className="relative z-10 mx-auto w-full max-w-md">
          ...
          <div className="float-breathe mb-12">
            ...
            <p className="mt-3 text-2xl font-semibold text-white leading-snug">
              Good to see you again.
            </p>
            <p className="mt-1 text-sm text-body-cyan leading-relaxed">
              Pick up right where you left off and keep sharpening every answer.
            </p>
          </div>

      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 relative overflow-hidden border-r border-white/5 bg-[#050505]">
        ...
        <div className="relative z-10 max-w-lg mt-auto">
          <blockquote className="space-y-6">
            <p className="text-2xl font-medium text-white/90 leading-tight drop-shadow-xl">
              &quot;The insights I gained from my first session completely changed how I approach behavioral questions. It&apos;s like having a FAANG interviewer in your living room.&quot;
            </p>
            <footer className="text-sm">
              <div className="font-semibold text-[#00D6FF]">Alex Chen</div>
              <div className="text-white/50">Senior Product Manager</div>
            </footer>
          </blockquote>

          <div className="mt-12 flex gap-6 text-sm font-medium text-white/50">
